...
private static final ResourceBundle texts = ResourceBundle.getBundle("texts");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
       ...
       if(isAdded != null){
           if(rmNumb.equals(isAdded.getRoomNumber())){
               JOptionPane.showMessageDialog(this, texts.getString("roomAlreadyAdded"),texts.getString("roomAdded"), JOptionPane.WARNING_MESSAGE);
               return;
           }
       }
